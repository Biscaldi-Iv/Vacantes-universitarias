            ...
            <tbody class="table-group-divider">
                ...
                <td>
                        <div class="d-grid gap-2">
                            ...
                            "{{ $u->tipodoc }}",{{ $u->ndoc }},"{{$u->direccion}}")' data-bs-target="#modalU" data-bs-toggle="modal">Editar</button>
                        </div>
                    </td>
                    <td>
                        <div class="d-grid gap-2">
                            ...
                            "{{ $u->tipodoc }}",{{ $u->ndoc }},"{{$u->direccion}}")' data-bs-target="#modalU" data-bs-toggle="modal">Eliminar</button>
                        </div>
                    </td>
                </tr>
                @endforeach
