    ...
    @auth
        @if (auth()->user()->privilegio == 3)
            <div class="row-4 my-3">
                ...
                <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#modalU"
                    onClick="crear()">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="form-floating mb-3">
                                <input type="number" readonly class="form-control" name="idUniversidad" id="idUniversidad"
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="direccionUniversidad"
                                    id="direccionUniversidad" placeholder="Direccion de la universidad" required>
